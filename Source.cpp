...
int main()
{
	...
	do
	{
		...
		case '4': // print out the calendar of specified year to yourname.txt file
			// you implement this ******************
			get_input(year);
			fileName = "Calander.txt";
			print_calendar(year, fileName);
			break;
		case '5': // print out the calendar of specified year to yourname.txt file
		// you implement this ******************
			get_input(month,year);
			fileName = "monthCalander.txt";
			break;
...
void menu()
{
	...
	cout << "\n\t* 4. Print calendar of a given year to a file     *";
